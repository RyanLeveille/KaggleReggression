...
# Descriptive Stats
live.describe()
# Train                Id   MSSubClass  ...       YrSold      SalePrice
#count  1460.000000  1460.000000  ...  1460.000000    1460.000000
#mean    730.500000    56.897260  ...  2007.815753  180921.195890
#std     421.610009    42.300571  ...     1.328095   79442.502883
#min       1.000000    20.000000  ...  2006.000000   34900.000000
...
# Test                Id   MSSubClass  ...       MoSold       YrSold
...
# From this we can see it is very similar.

# Features List

live_columns = list(live.columns)
# This makes sense everything but sales.
...
live_numna = live.isnull().sum()
live_numna_col = live_numna[live_numna.values > 0]
#MSZoning           4
#LotFrontage      227
#Alley           1352
#Utilities          2
